...
from graded_common import (
    ...
    plot_frequency_response, save_frequency_csv, save_wav, play_audio, output_device_summary, input_device_summary, play_audio,
)
...
def main() -> int:
    ...
    if args.mode == "ambient":
        ...
        print(f"[ambient] input_device={input_device_summary(args.device)}")
    ...
    print(f"[measure-rx] input_device={input_device_summary(args.device)}")
