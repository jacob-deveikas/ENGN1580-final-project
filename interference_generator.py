...
from graded_common import FS, save_wav, play_audio, output_device_summary, play_audio
...
def main() -> int:
    ...
    print(f"[jammer] output_device={output_device_summary(args.device)}")
    if args.no_play:
        return 0
    play_audio(x, device=args.device, fs=FS)
    return 0
